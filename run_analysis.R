...
# Remove the numeric label ID since we now have the actual activity description
...
# Make variable names descriptive and meaningful, remove "()" and "-" characters
...
# To calculate the average for each variable the "aggregate" function is used with dot notation, 
# which applies "MEAN" function to all other variables not present in the formula 
# (e.g. all except subject + activity), grouped by subject + activity
